...
rep = urllib2.urlopen("http://www.tudou.com/crp/plist.action?jsoncallback=page_play_model_pListModelList__findAll&lcode=dylG3LgZH5w&app=2")
...
for icode in icode_list[-7:]:
	...
	pub_time_0 = str(pub_date).replace('-','/')
	#print pub_time_0
	# 5.content
