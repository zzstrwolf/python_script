...
def image_size_off(rootDir):
    for lists in os.listdir(rootDir):
        ...
        if lists[lists.rfind('.'):].lower() == '.jpg':
            ...
            #这里保存thumbnail以后的结果
            region.save(
                os.path.join("D:\\vmaig_blog\\blog\\static\\img\\thub2", lists))
            box = ()
...
def main():
    '''这里输入的参数是图片文件的位置'''
    image_size_off("D:\\vmaig_blog\\blog\\static\\img\\[Beautyleg] 美腿寫真 No.663 Jill 2012.04.09 [62P]".decode('utf-8').encode('gbk'))
